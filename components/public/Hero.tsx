...
export function Hero({ eyebrow, h1, subheadline, body, primary, secondary, words, stats, headshot }: Props) {
  return (
    <section className="relative overflow-hidden bg-bg">
      ...
      />
      <div className="relative container-page min-h-[100vh] pt-24 pb-20 grid lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
        <div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative">
            <div className="relative h-[320px] w-[260px] sm:h-[420px] sm:w-[340px] rounded-2xl overflow-hidden bg-navy shadow-cardHover">
              {headshot ? (
                <Image src={headshot} alt="Shoaib Ramani" fill className="object-cover" priority />
              ) : (
                <HeadshotPlaceholder />
              )}
